...
function create_users_routes_get(app){
    app.get("/", user_controller.show_all_products)
}

function create_users_routes_get_id(app){
    app.get("/product/:id", user_controller.show_one_product)
}

function create_users_routes_post(app){
    app.post("/new", jwt_authenticate.authenticateToken, user_controller.create_product)
}

function create_users_routes_put(app){
    app.put("/update/:id", jwt_authenticate.authenticateToken, user_controller.update_product)
}

function create_users_routes_delete(app){
    app.delete("/delete/:id",user_controller.delete_product)
}
